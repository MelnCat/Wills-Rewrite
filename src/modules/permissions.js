...
permissions[0] = () => true;
permissions[1] = (client, member) => member.permissions.has("MANAGE_GUILD");
permissions[2] = (client, member) => client.getMainMember(member.id) ? client.getMainMember(member.id).roles.has(client.mainRoles.employee.id) : false;
